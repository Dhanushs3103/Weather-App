...
export default function Home() {
  return (
     ...
     {/* Navbar */}
      ...
      <Link to="/weather"><Button marginLeft={"50px"} bg={"#4358f6"} color={"#FFFFFF"} mt={"20px"} p={"30px 70px"}fontSize={"20px"} fontWeight={"bold"} fontFamily={"Ubuntu, sans-serif"} _hover={{bg:"#1D24CA"}}>Get Started</Button></Link>
     </div>
  )
}
